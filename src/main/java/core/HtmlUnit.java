...
public class HtmlUnit {
	...
	public static boolean isElementPresentHtmlUnit(HtmlPage page, String by) {
		if(page.getElementsById(by).size() > 0) return true; else return false;}
	...
	public static String getValueHtmlUnit(HtmlPage page, String by) {
		if (isElementPresentHtmlUnit(page, by)) 
		return page.getElementById(by).getTextContent().trim(); else return "null";}
...
// 01 :: First Name
		...
		report.write("01,HtmlUnit,index.php,First Name," + isElementPresentHtmlUnit(index_page, p.getProperty("fname_id")) + "," + p.getProperty("fname_value") + "\n");
		System.out.print("01,HtmlUnit,index.php,First Name," + isElementPresentHtmlUnit(index_page, p.getProperty("fname_id")) + "," + p.getProperty("fname_value") + "\n");
...
// 02 :: Last Name
		...
		report.write("02,HtmlUnit,index.php,Last Name," + isElementPresentHtmlUnit(index_page, p.getProperty("lname_id")) + "," + p.getProperty("lname_value") + "\n");
		System.out.print("02,HtmlUnit,index.php,Last Name," + isElementPresentHtmlUnit(index_page, p.getProperty("lname_id")) + "," + p.getProperty("lname_value") + "\n");
...
// 08 :: Phone
		...
		System.out.print("08,HtmlUnit,confirmation.php,Phone," +
				isElementPresentHtmlUnit(index_page, p.getProperty("phone_id")) + "," + 
				getValueHtmlUnit(confirmation_page, p.getProperty("phone_id")) + "\n");
